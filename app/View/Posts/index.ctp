<div class="posts index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('user_post_id'); ?></th>
			<th><?php echo $this->Paginator->sort('type'); ?></th>
			<th><?php echo $this->Paginator->sort('video'); ?></th>
			<th><?php echo $this->Paginator->sort('image'); ?></th>
			<th><?php echo $this->Paginator->sort('user_view'); ?></th>
			<th><?php echo $this->Paginator->sort('user_like'); ?></th>
			<th><?php echo $this->Paginator->sort('comment_id'); ?></th>
			<th><?php echo $this->Paginator->sort('category_id'); ?></th>
			<th><?php echo $this->Paginator->sort('created_datetime'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($post['Post']['avatar']); ?>&nbsp;</td>
		<td><?php echo h($post['Post']['description']); ?>&nbsp;</td>
		<td><?php echo h($post['Post']['content']); ?>&nbsp;</td>
		<td><?php echo h($post['Post']['user_post_id']); ?>&nbsp;</td>
		<td><?php echo h($post['Post']['type']); ?>&nbsp;</td>
		<td><?php echo h($post['Post']['video']); ?>&nbsp;</td>
		<td><?php echo h($post['Post']['image']); ?>&nbsp;</td>
		<td><?php echo h($post['Post']['user_view']); ?>&nbsp;</td>
		<td><?php echo h($post['Post']['user_like']); ?>&nbsp;</td>
		<td><?php echo h($post['Post']['comment_id']); ?>&nbsp;</td>
		<td><?php echo h($post['Post']['category_id']); ?>&nbsp;</td>
		<td><?php echo h($post['Post']['created_datetime']); ?>&nbsp;</td>
		<td class="actions">
