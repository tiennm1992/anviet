    ...
    <body class="skin-blue">
        ...
        <div class="wrapper">
            <header class="main-header">
                <a href="<?php echo $this->Html->url(array('controller' => 'admin', 'action' => 'index', 'admin' => true), true); ?>" class="logo"><b>Pokemon Go</b></a>
            ...
            <footer class="main-footer">
                <strong>Copyright &copy; 2016 <a href="#">Pokemon Go management</a>.</strong> All rights reserved.
            </footer>
        </div><!-- ./wrapper -->
